...
{
    public class CambiosControllerTests
    {
        // Preparação  
        private readonly Mock<ICambioRepository> _mock; // A função Mock cria um repositório "fake" para usá-lo no controller
        private readonly CambiosController _ctl;

        public CambiosControllerTests()  // Gerando um método construtor
        {
            _mock = new Mock<ICambioRepository>();
            _ctl = new CambiosController(_mock.Object);
        }
        /// <summary>
        ...
        public void TestActionResultGetReturnOk()
        {
            ...
            // Execução
            var result = _ctl.GetCambios(); // Ele busca o método GET criado no Controller verdadeiro
            // Retorno
        ...
        {
            // Execução - Act
            var actionResult = _ctl.GetCambios();
