...
namespace EduCar.Migrations
{
    ...
    [Migration("20221010133424_AtualizacaoStatusVenda")]
    partial class AtualizacaoStatusVenda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduCar.Models.StatusVenda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduCar.Models.Pedido", b =>
                {
                    b.HasOne("EduCar.Models.Cartao", "Cartao")
                        .WithMany()
            ...
            modelBuilder.Entity("EduCar.Models.Veiculo", b =>
                {
                    ...
                    b.HasOne("EduCar.Models.StatusVenda", "StatusVenda")
                        .WithMany("Veiculos")
                        .HasForeignKey("IdStatusVenda")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
